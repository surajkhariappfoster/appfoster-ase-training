  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="editUserForm" method="POST" action="{{ route('users.update', ['id' => $user->id]) }}">
            @csrf
            @method('PUT')

            <div class="form-group">
                <label>ID</label>
                <input type="text" name="name" id="editUserID" class="form-control" value="{{ $user->id }}" readonly/>
            </div>
            <div class="form-group">
                <label>Name</label>
                <input type="text" name="name" id="editUserName" class="form-control" value="{{ $user->name }}"/>
            </div>
            <div class="form-group">
                <label>Email</label>
                <input type="text" name="email" id="editUserEmail" class="form-control" value="{{ $user->email }}"/>
            </div>
            <div class="form-group">
                <label>Gender</label>
                <input type="text" name="gender" id="editUserGender" class="form-control" value="{{ $user->gender }}"/>
            </div>
            <div class="form-group">
                <label>Status</label>
                <input type="text" name="status" id="editUserStatus" class="form-control" value="{{ $user->status }}"/>
            </div>
            <button type="submit" class="btn btn-dark">Submit</button>
                ...
                <!-- Edit button -->
                <button type="button" class="btn btn-dark" onclick="openEditModal({{ $user->id }})">Edit</button>
                    ...
                    <a href="{{ route('users.projects', ['id' => $user->id]) }}" class="btn btn-secondary">Project</a>
                </td>
            </tr>
            @endforeach
        </tbody>
      ...
      <div class="modal-body">
        ...
        <form id="addUserForm" method="POST" action="{{ route('users.store') }}">
            ...
            <div class="form-group">
                ...
                <input type="number" name="id" class="form-control" id="id" value="{{ old('id') }}"/>
            </div>
            <div class="form-group">
